...
public class ModifyingTableDemo extends JFrame {
	...
	public ModifyingTableDemo() {
		...
		// adding the table to a scroll pane to make it scrollable(table is not
		// scrollable by default)
		add(new JScrollPane(table), BorderLayout.CENTER);
		add(p3, BorderLayout.SOUTH);

		// setting the selection mode to multiple interval(multiple items can be
		// selected)
...
//		});
		...
		// deleting data(we need to save the change after we press the clear button
		// otherwise the deletion will not work)
